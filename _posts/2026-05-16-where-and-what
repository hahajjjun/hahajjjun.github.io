...
These were asking the name of a human anatomical structure based after looking at it for a very short amount of time. 
...
Similar to the previous episode, patch-based learning results in a narrower field of view compared to the entire image.
